	...
	m_reloadTimer(0)
{
    ...
    registerAction(AboutApplicationAction, QT_TRANSLATE_NOOP("actions", "About Waterphoenix…"), {}, ThemesManager::createIcon(QLatin1String("waterphoenix-browser"), false), ActionDefinition::ApplicationScope, (ActionDefinition::IsEnabledFlag | ActionDefinition::IsImmutableFlag));
